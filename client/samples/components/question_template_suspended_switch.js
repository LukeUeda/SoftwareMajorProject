...
export default class QuestionTemplateSuspendedSwitch extends Component {
    ...
    handleChange(checked) {
        ...
        let url = `${API_URL}${API_QUESTIONS_PATH}/${this.props.id}/suspended/${checked}`;
        ...
        fetch(url, apiConfig)
            ...
            .catch(
                error => {
                    console.error( error);
                    alert("Failed to update the suspended flag");
