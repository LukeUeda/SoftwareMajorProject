...
import {API_TESTS_PATH, API_URL, DEFAULT_NO_OF_QUESTIONS, PATH_TESTS} from '../common/constants';
...
class TestGeneration extends Component {
    ...
    componentDidMount() {
        ...
        let url = `${API_URL}${API_TESTS_PATH}/${params.id}?noOfQuestions=${DEFAULT_NO_OF_QUESTIONS}`;
